...
# Send a cross-session broadcast message
#
# Usage:
#   ./session-broadcast.sh "message"
#   ./session-broadcast.sh --auto "file name" "change description"
#
# Output: appends the broadcast message to .claude/sessions/broadcast.md
...
MAX_MESSAGES=100  # Max number of messages to keep
...
main() {
  ...
  # Delete old messages (when MAX_MESSAGES is exceeded)
