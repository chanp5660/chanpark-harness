...
#
# Check items:
# 1. Whether the *.template files in templates/ are registered in the registry
# 2. Whether the files in the registry exist in templates/
# 3. Whether templateVersion has a valid format
...
# 1. Check whether the files in templates/ are registered in the registry
echo ""
...
for template_path in $TEMPLATE_FILES; do
  # Get the path relative to templates/
...
# 2. Check whether the files in the registry exist in templates/
echo ""
...
# 4. Check for duplicate output paths
echo ""
