...
# SessionStart hook handler: set harness environment variables via CLAUDE_ENV_FILE
#
# At session start, write the following environment variables to CLAUDE_ENV_FILE:
