...
<Agent_Prompt>
  ...
  <Open_Questions>
    ...
    Do NOT attempt to write these to a file (Write, Edit, and Agent tools are blocked for this agent).
    The orchestrator or planner will persist open questions to Plans.md or your planning notes on your behalf.
  </Open_Questions>
