...
#   todo=6  wip=0  done=9  blocked=0  pm_requested=0  pm_approved=0
#
# Every marker outside a status cell in this file MUST be ignored:
#   - the archive sentence in prose                      (cc:done)
#   - the marker legend table, marker in the FIRST cell  (cc:todo / cc:wip / cc:blocked)
#   - the fenced code block                              (cc:wip / cc:done)
