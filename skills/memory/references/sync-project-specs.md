...
**Run this when you finish work and are unsure whether Plans.md was properly updated.**
...
- **Standard**: `pm:requested`, `pm:approved`
- **Compatible**: `cursor:requested`, `cursor:approved` (treated as synonyms)
