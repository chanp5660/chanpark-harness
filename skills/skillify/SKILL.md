...
name: skillify
aliases: [learner]
description: Turn a repeatable workflow from the current session into a reusable chanpark-harness skill draft
---

# Skillify

Use this skill when the current session uncovered a repeatable workflow that should become a reusable skill in chanpark-harness.

> Compatibility: `learner` is a deprecated alias for this skill. Prefer `skillify` in docs, prompts, and new workflows.
...
- Keep `learned` as the storage directory name; do not present it as the public invocation name.
